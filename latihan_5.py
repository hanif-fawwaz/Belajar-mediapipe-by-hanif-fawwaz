    ...
    while cap.isOpened():
        ...
        if result.multi_hand_landmarks:
            for hand_landmarks in result.multi_hand_landmarks:
                ...
                distance2 = math.hypot(x4 - x3, y4 - y3)
                # cv2.line(frame, (x3, y3), (x4, y4), (0, 255, 0), 2)
                cv2.putText(frame, f"Jarak: {int(distance2)}", (10, 160),
                ...
                # Logika "Menekuk"
                if angle > 60:
                    cv2.putText(frame, "Telunjuk Menekuk", (10, 200),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                # Logika "Mengepal"
                if angle < 50:
                    cv2.putText(frame, "Mengepal", (10, 40),
                                cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
